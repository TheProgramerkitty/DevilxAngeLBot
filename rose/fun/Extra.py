...
◇️ ━━━━━━━━━ ◇️
👨‍💻 **Generated By**: [Devil Network](https://t.me/DevilAngelupdates)
🙋‍♂️ **Requestor** : {}
⚡️ **Powered By**   : [Devil support](https://t.me/DevilAngelSupport)
◇️ ━━━━━━━━━ ◇️
**©2022** [Devil Angel](http://t.me/DevilxAngeLBot) **Bot All Rights Reserved**
"""
...
picmebtns = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("✘Support Chat✘", url="https://t.me/DevilAngelSupport"),
                    InlineKeyboardButton("✘Updates Channel✘", url="https://t.me/DeviLAngeLupdates")       
                ],         
            ]
        )
pm = """
...
◇───────────────◇
👨‍💻 **Generated By** : [Devil Angel](t.me/DevilxAngeLBot)
🙋‍♂️ **Requestor** : {}
⚡️ **Powered By**   : [Devil Network](https://t.me/DeviLAngeLupdates)
◇───────────────◇️
**©2022** [@DevilxAngeLBot](http://t.me/DevilxAngeLBot) **Bot All Rights Reserved**
"""
...
async def sendthepicme(_, message):
    await app.send_photo(chat_id=int(CHANNEL),photo="https://telegra.ph/file/1d9916f19be29e9013ae0.jpg",caption=picmetxt.format(message.from_user.mention), reply_markup=picmebtns)
...
""", show_alert=True)
    ...
    if mode == "pm":
        try:
            ...
            await query.answer("Please Frist Start This 👉 @DeviLxAngeLBot")
            print(str(e))
            if os.path.exists(photo):os.remove(photo)     
