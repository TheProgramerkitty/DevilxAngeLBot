...
`◇───────────────◇`
👨‍💻 **Generated By** : [DevilxAngeLBot](https://t.me/DevilxAngeLBot)
🙋‍♂️ **Requestor** : {}
⚡️ **Powered By **  : [Devil Network](https://t.me/DeviLAngeLupdates)
`◇───────────────◇️ ` 
    """
JOIN_ASAP = f" **🚫 Access Denied**\n\n You Must Join [My News Channel](https://t.me/DeviLAngeLupdates)To Use Me. So, Please Join it & Try Again." 
FSUBB = InlineKeyboardMarkup( 
           [[ 
               InlineKeyboardButton(text="News Channel ", url=f"https://t.me/DeviLAngeLupdates") 
           ]] 
)
